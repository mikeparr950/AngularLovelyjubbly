...
@Component({
    selector: 'app-playresult-list',
    templateUrl: '../playresults/playresult-list.component.html'
})
export class PlayResultListComponent implements OnInit {
    /**properties */
    errorMessage: string;
    ...
    refreshPlayResultList() {
        this._playResultService.getPlayResults()
